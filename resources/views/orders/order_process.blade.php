        ...
        <div class="col-md-12">
            <div class="panel panel-flat border-top-success">
                <div class="panel-heading">
                    <h6 class="panel-title">Orders in process</h6>
                </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control trackNumber" placeholder="Track Number">
                        </div>
                        ...
                        @foreach($table as $row)
                            ...
                            <tr>
                                ...
                                <td class="text-right white_sp">
                                    <button type="button" class="btn btn-xs btn-info no-padding mr-5 view_btn" data-id="{{$row->orderID}}" data-status="Shipped" data-url="{{route('order-show', ['id' => $row->orderID])}}" data-toggle="modal" data-target="#shippedModal" title="View Order"><i class="icon-eye"></i></button>
        ...
        $(function () {
            ...
            $('.view_btn').click(function () {
                ...
                $.get( url, function( result ) {
                    ...
                    $( "#shippedModal [name=orderID]" ).val(orderID);
                    $( "#shippedModal [name=status]" ).val(status);
