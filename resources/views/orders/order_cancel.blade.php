        ...
        <div class="col-md-12">
            <div class="panel panel-flat border-top-success">
                <div class="panel-heading">
                    <h6 class="panel-title">Cancel Order List</h6>
                </div>
                        ...
                        @foreach($table as $row)
                            ...
                            <tr>
                                ...
                                <td class="text-right white_sp">
                                    ...
                                    <a class="btn btn-xs btn-danger no-padding" href="{{route('order-del', ['id' => $row->orderID])}}" onclick="return confirm('Are you sure to delete this order?')" title="Delete"><i class="icon-bin"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
