                        ...
                        @foreach($table as $row)
                            ...
                            <tr>
                                ...
                                <td class="text-right white_sp">
                                    <button type="button" class="btn btn-xs btn-info no-padding mr-5 view_btn" data-status="{{route('order-status', ['id' => $row->orderID, 'status' => 'complete'])}}" data-url="{{route('order-show', ['id' => $row->orderID])}}" data-toggle="modal" data-target="#myModal" title="View Order"><i class="icon-eye"></i></button>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('.datatable').DataTable({
                order: [[ 0, "desc" ]],
                columnDefs: [
                    { orderable: false, "targets": [0,10] }//For Column Order
                ]
            });
