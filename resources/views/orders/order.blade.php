        ...
        <div class="col-md-12">
            <div class="panel panel-flat border-top-success">
                <div class="panel-heading">
                    <h6 class="panel-title">Initial Orders</h6>
                </div>
                        ...
                        @foreach($table as $row)
                            ...
                            <tr>
                                ...
                                <td class="text-right white_sp">
                                    <button type="button" class="btn btn-xs btn-info no-padding mr-5 view_btn" data-status="{{route('order-status', ['id' => $row->orderID, 'status' => 'paid'])}}" data-url="{{route('order-show', ['id' => $row->orderID])}}" data-toggle="modal" data-target="#myModal" title="View Order"><i class="icon-eye"></i></button>
